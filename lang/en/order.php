...
return [
    ...
    */
    ...
    'messages' => [
        ...
        'order_was_successfully_delivered' => 'Your order has been successfully delivered'
    ],
    'validations' => [
    ],
    'errors' => [
        ...
        'order_already_assigned_driver' => 'This order is already assigned to a driver',
        'can_not_deliver_this_order' => 'Can not deliver this order'
    ],
